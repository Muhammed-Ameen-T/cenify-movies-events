...
import { WalletData, Transaction, WalletTransactionsResponse } from '../../types';
...
const AdminWalletTab: React.FC = () => {
  ...
  const {
    ...
    queryKey: ['adminWalletTransactions', userId, currentLimit, filterType],
    queryFn: async () => {
      ...
      <div className="min-h-screen bg-gray-950 px-4 py-6">
        <div className="max-w-4xl mx-auto">
          ...
          >
            ...
            <h3 className="text-xl font-semibold text-white mb-2">Error Loading Admin Wallet</h3>
        ...
        <motion.div variants={itemVariants} className="mb-6">
          ...
          <div className="flex items-center gap-3 mt-3 mb-6">
            ...
            <div>
              ...
              <p className="text-gray-400 text-sm">Manage platform finances and transactions</p>
            </div>
          </div>
        </motion.div>
          ...
          <div className="bg-gradient-to-r from-purple-600 to-pink-600 rounded-2xl p-6 text-white relative overflow-hidden">
            ...
            <div className="relative z-10">
              <div className="flex items-center justify-between mb-4">
                <span className="text-purple-100 text-sm font-medium">Platform Balance</span>
                <motion.button
              ...
              <div className="text-purple-200 text-sm">Total platform wallet balance</div>
            </div>
          </div>
        </motion.div>
        ...
        <motion.div variants={itemVariants} className="bg-gray-900 rounded-2xl p-6 border border-gray-800 mb-6">
          ...
          <div className="flex flex-col sm:flex-row gap-4 mb-6">
            <div className="relative flex-1">
              ...
              <input
                ...
                className="w-full bg-gray-800 border border-gray-700 rounded-lg pl-10 pr-4 py-2.5 text-white placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-purple-500 focus:border-purple-500"
              />
            </div>
            <select
              value={filterType}
              onChange={(e) => handleFilterChange(e.target.value as 'all' | 'credit' | 'debit')}
              className="bg-gray-800 border border-gray-700 rounded-lg px-4 py-2.5 text-white focus:outline-none focus:ring-2 focus:ring-purple-500 focus:border-purple-500"
            >
          ...
          <div className="flex gap-2 mb-6 overflow-x-auto">
            {[
              ...
              { key: 'credit', label: 'Inflow', count: creditCount },
              { key: 'debit', label: 'Outflow', count: debitCount },
            ].map((tab) => (
              <motion.button
                key={tab.key}
          ...
          >
            ...
            >
              <div className="flex justify-between items-start mb-6">
                <div>
                  <h3 className="text-xl font-semibold text-white mb-2">Admin Transaction Details</h3>
              ...
              <div className="space-y-4">
                  ...
                  <div className="space-y-3 text-sm">
                    ...
                    <div className="flex justify-between">
                      ...
                      <span className="text-white capitalize">
                        {selectedTransaction.type === 'credit' ? 'Inflow' : 'Outflow'}
                      </span>
                    </div>
                    <div className="flex justify-between">
                ...
                <div className="bg-gray-800 rounded-xl p-4">
                  ...
                  <div className="text-sm text-gray-400">
                    This transaction affects the platform's overall financial balance and may impact commission calculations, refunds, or administrative operations.
                  </div>
                </div>
              </div>
            </motion.div>
