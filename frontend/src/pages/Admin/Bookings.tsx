    ...
    >
      ...
      <div className="flex flex-col flex-1 overflow-hidden">
        ...
        <main className="flex-1 overflow-y-auto p-6">
          <h1 className="mb-6 text-2xl font-bold text-white">Bookings Management</h1>
          
          <div className="bg-gray-800 rounded-xl p-8 flex items-center justify-center h-80 shadow-lg border border-gray-700">
            <p className="text-gray-400 text-lg">Bookings management page is under development...</p>
          </div>
        </main>
      </div>
    </motion.div>
