...
export class SendOtpUseCase implements ISendOtpUseCase {
  ...
  async execute(email: string): Promise<void> {
    ...
    try {
      ...
      throw new CustomError('Failed to store OTP in Redis.', HttpResCode.INTERNAL_SERVER_ERROR);
    }
    ...
    try {
      ...
      throw new CustomError('Failed to send OTP email.', HttpResCode.INTERNAL_SERVER_ERROR);
    }
  }
}
